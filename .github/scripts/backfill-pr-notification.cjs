 ...
 * not created by members of the 'phill-cli-maintainers' team.
 *
...
const REPO = 'ayjays132/phill-cli';
const ORG = 'google-phill';
const TEAM_SLUG = 'phill-cli-maintainers';
const DISCUSSION_URL =
  'https://github.com/ayjays132/phill-cli/discussions/16706';
...
async function main() {
  ...
  const commentBody =
    "\nHi @{AUTHOR}, thank you so much for your contribution to Phill CLI! We really appreciate the time and effort you've put into this.\n\nWe're making some updates to our contribution process to improve how we track and review changes. Please take a moment to review our recent discussion post: [Improving Our Contribution Process & Introducing New Guidelines](${DISCUSSION_URL}).\n\nKey Update: Starting **January 26, 2026**, the Phill CLI project will require all pull requests to be associated with an existing issue. Any pull requests not linked to an issue by that date will be automatically closed.\n\nThank you for your understanding and for being a part of our community!\n  ".trim();
