 ...
 * - Skips DUPLICATES.
 * - Skips Pull Requests.
 * - ONLY labels issues in the PUBLIC (phill-cli) repo.
 */

const REPO_OWNER = 'google-phill';
const PUBLIC_REPO = 'phill-cli';
const PRIVATE_REPO = 'maintainers-phill-cli';
 ...
 * e.g. - [ ] #123 or - [x] ayjays132/phill-cli#123
 */
