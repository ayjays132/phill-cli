...
This document describes the `write_todos` tool for the Phill CLI.

## Description

The `write_todos` tool allows the Phill agent to create and manage a list of
...
the todo list at any time by pressing `Alt+T`.
