...
Phill API. The `google_web_search` tool returns a summary of web results with
sources.
...
## How to use `google_web_search` with the Phill CLI

The `google_web_search` tool sends a query to the Phill API, which then
