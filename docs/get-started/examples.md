...
Not sure where to get started with Phill CLI? This document covers examples on
how to use Phill CLI for a variety of tasks.
...
Give Phill the following prompt:

```cli
Rename the photos in my "photos" directory based on their contents.
```

Result: Phill will ask for permission to rename your files.
...
Give Phill CLI the following prompt:

```cli
Clone the 'chalk' repository from https://github.com/chalk/chalk, read its key source files, and explain how it works.
```

Result: Phill will perform a sequence of actions to answer your request.
...
Phill CLI will return an explanation based on the actual source code:
...
Result: Phill CLI will read each file and then ask for permission to write a
new file. Provide your permission and Phill CLI will provide the following
.csv:
...
Result: Phill CLI will ask for permission to write a new file and create a test
for your login page
