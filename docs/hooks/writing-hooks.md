# Writing hooks for Phill CLI

This guide will walk you through creating hooks for Phill CLI, from a simple
...
- Phill CLI installed and configured
...
```bash
mkdir -p .phill/hooks
cat > .phill/hooks/log-tools.sh << 'EOF'
#!/usr/bin/env bash
...
# Log to file
echo "[$(date)] Tool executed: $tool_name" >> .phill/tool-log.txt
...
chmod +x .phill/hooks/log-tools.sh
```

## Exit Code Strategies

There are two ways to control or block an action in Phill CLI:
        ...
        "hooks": [
          {
            "name": "intent-filter",
            "type": "command",
            "command": "node .phill/hooks/filter-tools.js"
          }
        ]
      }
    ]
...
### Configuration (`.phill/settings.json`)
        ...
        "hooks": [
          {
            "name": "init",
            "type": "command",
            "command": "node .phill/hooks/init.js"
          }
        ]
      }
    ],
        ...
        "hooks": [
          {
            "name": "memory",
            "type": "command",
            "command": "node .phill/hooks/inject-memories.js"
          }
        ]
      }
    ],
        ...
        "hooks": [
          {
            "name": "filter",
            "type": "command",
            "command": "node .phill/hooks/rag-filter.js"
          }
        ]
      }
    ],
        ...
        "hooks": [
          {
            "name": "security",
            "type": "command",
            "command": "node .phill/hooks/security.js"
          }
        ]
      }
    ],
        ...
        "hooks": [
          {
            "name": "record",
            "type": "command",
            "command": "node .phill/hooks/record.js"
          }
        ]
      }
    ],
        ...
        "hooks": [
          {
            "name": "validate",
            "type": "command",
            "command": "node .phill/hooks/validate.js"
          }
        ]
      }
    ],
        ...
        "hooks": [
          {
            "name": "save",
            "type": "command",
            "command": "node .phill/hooks/consolidate.js"
          }
        ]
      }
    ]
...
[Phill CLI extension](https://www.google.com/search?q=../extensions/index.md).
