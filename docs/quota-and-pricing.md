# Phill CLI: Quotas and pricing

Phill CLI offers a generous free tier that covers many individual developers'
...
This article outlines the specific quotas and pricing applicable to Phill CLI
...
### Log in with Google (Phill Code Assist for individuals)

For users who authenticate by using their Google account to access Phill Code
Assist for individuals. This includes:

- 1000 model requests / user / day
- 60 model requests / user / minute
- Model requests will be made across the Phill model family as determined by
  Phill CLI.

Learn more at
[Phill Code Assist for Individuals Limits](https://developers.google.com/gemini-code-assist/resources/quotas#quotas-for-agent-mode-gemini-cli).

### Log in with Phill API Key (unpaid)

If you are using a Phill API key, you can also benefit from a free tier. This
includes:
...
Learn more at
[Phill API Rate Limits](https://ai.google.dev/gemini-api/docs/rate-limits).
...
Phill CLI by upgrading to one of the following subscriptions:

- [Google AI Pro and AI Ultra](https://phill.google/subscriptions/). This is
  ...
  Learn more at
  [Phill Code Assist Quotas and Limits](https://developers.google.com/gemini-code-assist/resources/quotas)

- [Purchase a Phill Code Assist Subscription through Google Cloud ](https://cloud.google.com/gemini/docs/codeassist/overview)
  by signing up in the Google Cloud console. Learn more at
  [Set up Phill Code Assist](https://cloud.google.com/gemini/docs/discover/set-up-gemini).
  ...
  This includes:
  - Phill Code Assist Standard edition:
    - 1500 model requests / user / day
    - 120 model requests / user / minute
  - Phill Code Assist Enterprise edition:
    - 2000 model requests / user / day
    - 120 model requests / user / minute
  - Model requests will be made across the Phill model family as determined by
    Phill CLI.

  [Learn more about Phill Code Assist Standard and Enterprise license limits](https://developers.google.com/gemini-code-assist/resources/quotas#quotas-for-agent-mode-gemini-cli).

## Pay as you go

If you hit your daily request limits or exhaust your Phill Pro quota even after
...
To do this, log in using a Phill API key or Vertex AI.
...
Learn more at
[Phill API Rate Limits](https://ai.google.dev/gemini-api/docs/rate-limits),
[Phill API Pricing](https://ai.google.dev/gemini-api/docs/pricing)
...
## Phill for workspace plans

These plans currently apply only to the use of Phill web-based products provided
by Google-based experiences (for example, the Phill web app or the Flow video
editor). These plans do not apply to the API usage which powers the Phill CLI.
Supporting these plans is under active consideration for future support.
...
- Phill API (phill developer api): This is the fastest way to use the Phill
  models directly.
- Vertex AI: This is the enterprise-grade platform for building, deploying, and
  managing Phill models with specific security and control requirements.
