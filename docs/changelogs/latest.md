...
- **Core Functionality & Performance:** Support for built-in agent skills,
  refined Phill 3 system instructions, caching ignore instances for
...
- fix(patch): cherry-pick cfdc4cf to release/v0.25.0-preview.0-pr-16759 to patch
  ...
  @phill-cli-robot in
  [#16866](https://github.com/ayjays132/phill-cli/pull/16866)
- Patch #16730 into v0.25.0 preview by @chrstnb in
  [#16882](https://github.com/ayjays132/phill-cli/pull/16882)
- fix(patch): cherry-pick 3b55581 to release/v0.25.0-preview.2-pr-16506 to patch
  ...
  @phill-cli-robot in
  [#17098](https://github.com/ayjays132/phill-cli/pull/17098)

**Full changelog**:
https://github.com/ayjays132/phill-cli/compare/v0.24.5...v0.25.0
