# Phill CLI release notes

Phill CLI has three major release channels: nightly, preview, and stable. For
...
[Releases - google-phill/phill-cli](https://github.com/ayjays132/phill-cli/releases)
on GitHub.
...
- **Agent Skills:** We've introduced significant advancements in Agent Skills.
  ...
  and powerful automation within Phill CLI.
  ([#15869](https://github.com/ayjays132/phill-cli/pull/15869) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#16013](https://github.com/ayjays132/phill-cli/pull/16013) by
...
- **Improved UI/UX:** The user interface has received several updates, featuring
  ...
  and input areas.
  ([#15408](https://github.com/ayjays132/phill-cli/pull/15408) by
...
- **Enhanced Security:** Security has been a major focus, with default folder
  ...
  ([#15943](https://github.com/ayjays132/phill-cli/pull/15943) by
  [@galz10](https://github.com/galz10)),
  ([#15977](https://github.com/ayjays132/phill-cli/pull/15977) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))
- **Core Functionality:** This release includes a mandatory MessageBus
  ...
  ([#15776](https://github.com/ayjays132/phill-cli/pull/15776) by
  [@abhipatel12](https://github.com/abhipatel12)),
  ([#16300](https://github.com/ayjays132/phill-cli/pull/16300) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))
- **Terminal Features:** Terminal interactions are more seamless with new
  ...
  ([#15336](https://github.com/ayjays132/phill-cli/pull/15336) by
  [@scidomino](https://github.com/scidomino)),
  ([#15932](https://github.com/ayjays132/phill-cli/pull/15932) by
  [@scidomino](https://github.com/scidomino))
- **New Commands:** To manage the new features, we've added several new
  ...
  ([#16204](https://github.com/ayjays132/phill-cli/pull/16204) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#15865](https://github.com/ayjays132/phill-cli/pull/15865) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#16377](https://github.com/ayjays132/phill-cli/pull/16377) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))

## Announcements: v0.23.0 - 2026-01-07

- 🎉 **Experimental Agent Skills Support in Preview:** Phill CLI now supports
  [Agent Skills](https://agentskills.io/home) in our preview builds. This is an
  early preview where we’re looking for feedback!
  - Install Preview: `npm install -g phill-cli@preview`
  - Enable in `/settings`
  - Docs:
    [https://phillcli.com/docs/cli/skills/](https://phillcli.com/docs/cli/skills/)
- **Phill CLI wrapped:** Run `npx phill-wrapped` to visualize your usage
...
- **Windows clipboard image support:** Windows users can now paste images
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/13997) by
...
- **Terminal background color detection:** Automatically optimizes your
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/15132) by
...
- 🎉**Phill CLI Extensions:**
  ...
  - **Endor Labs:** Perform code analysis, vulnerability scanning, and
    ...
    `phill extensions install https://github.com/endorlabs/phill-extension`

## Announcements: v0.21.0 - 2025-12-15

- **⚡️⚡️⚡️ Phill 3 Flash + Phill CLI:** Better, faster and cheaper than 2.5
...
- For more information:
  [Phill 3 Flash is now available in Phill CLI](https://developers.googleblog.com/gemini-3-flash-is-now-available-in-gemini-cli/).
- 🎉 Phill CLI Extensions:
  - Rill: Utilize natural language to analyze Rill data, enabling the
    ...
    `phill extensions install https://github.com/rilldata/rill-phill-extension`
  - Browserbase: Interact with web pages, take screenshots, extract information,
    ...
    `phill extensions install https://github.com/browserbase/mcp-server-browserbase`
...
- **Multi-file Drag & Drop:** Users can now drag and drop multiple files into
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/14832) by
...
- **Persistent "Always Allow" Policies:** Users can now save "Always Allow"
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/14737) by
...
- 🎉 **New extensions:**
  - **Eleven Labs:** Create, play, manage your audio play tracks with the Eleven
    Labs Phill CLI extension:
    `phill extensions install https://github.com/elevenlabs/elevenlabs-mcp`
- **Zed integration:** Users can now leverage Phill 3 within the Zed
  integration after enabling "Preview Features" in their CLI’s `/settings`.
  ([pr](https://github.com/ayjays132/phill-cli/pull/13398) by
...
- **Interactive shell:**
  - **Click-to-Focus:** When "Use Alternate Buffer" setting is enabled, users
    ...
    ([pr](https://github.com/ayjays132/phill-cli/pull/13341) by
    [@galz10](https://github.com/galz10))
  - **Loading phrase:** Clearly indicates when the interactive shell is awaiting
    user input. ([vid](https://imgur.com/a/kjK8bUK),
    [pr](https://github.com/ayjays132/phill-cli/pull/12535) by
    [@jackwotherspoon](https://github.com/jackwotherspoon))

## Announcements: v0.18.0 - 2025-11-17

- 🎉 **New extensions:**
  - **Google Workspace**: Integrate Phill CLI with your Workspace data. Write
    docs, build slides, chat with others or even get your calc on in sheets:
    `phill extensions install https://github.com/phill-cli-extensions/workspace`
    - Blog:
  ...
  - **Redis:** Manage and search data in Redis with natural language:
    `phill extensions install https://github.com/redis/mcp-redis`
  - **Anomalo:** Query your data warehouse table metadata and quality status
    through commands and natural language:
    `phill extensions install https://github.com/datagravity-ai/anomalo-phill-extension`
- **Experimental permission improvements:** We are now experimenting with a new
  policy engine in Phill CLI. This allows users and administrators to create
...
- **Phill 3 support for paid:** Phill 3 support has been rolled out to all API
  key, Google AI Pro or Google AI Ultra (for individuals, not businesses) and
  Phill Code Assist Enterprise users. Enable it via `/settings` and toggling on
  **Preview Features**.
...
- **Model in history:** Users can now toggle in `/settings` to display model in
  ...
  [pr](https://github.com/ayjays132/phill-cli/pull/13034) by
  [@scidomino](https://github.com/scidomino))
- **Multi-uninstall:** Users can now uninstall multiple extensions with a single
  command. ([pic](https://imgur.com/a/9Dtq8u2),
  [pr](https://github.com/ayjays132/phill-cli/pull/13016) by
  [@JayadityaGit](https://github.com/JayadityaGit))

## Announcements: v0.16.0 - 2025-11-10

- **Phill 3 + Phill CLI:** launch 🚀🚀🚀
- **Data Commons Phill CLI Extension** - A new Data Commons Phill CLI
  ...
  be found at
  [https://github.com/phill-cli-extensions/datacommons](https://github.com/phill-cli-extensions/datacommons).

## Announcements: v0.15.0 - 2025-11-03

- **🎉 Seamless scrollable UI and mouse support:** We’ve given Phill CLI a
...
- **🎉 New partner extensions:**
  - **Arize:** Seamlessly instrument AI applications with Arize AX and grant
    ...
    `phill extensions install https://github.com/Arize-ai/arize-tracing-assistant`

  - **Chronosphere:** Retrieve logs, metrics, traces, events, and specific
    entities:

    `phill extensions install https://github.com/chronosphereio/chronosphere-mcp`
  ...
  - **Transmit:** Comprehensive context, validation, and automated fixes for
    ...
    `phill extensions install https://github.com/TransmitSecurity/transmit-security-journey-builder`
...
- **Todo planning:** Complex questions now get broken down into todo lists that
  ...
  [pr](https://github.com/ayjays132/phill-cli/pull/12905) by
...
- **Disable GitHub extensions:** Users can now prevent the installation and
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/12838) by
...
- **🎉 New partner extensions:**
  - **🤗 Hugging Face extension:** Access the Hugging Face hub.
    ...
    `phill extensions install https://github.com/huggingface/hf-mcp-server`
  ...
  - **Monday.com extension**: Analyze your sprints, update your task boards,
    ...
    `phill extensions install https://github.com/mondaycom/mcp`
  ...
  - **Data Commons extension:** Query public datasets or ground responses on
    ...
    `phill extensions install https://github.com/phill-cli-extensions/datacommons`

- **Model selection:** Choose the Phill model for your session with `/model`.
  ([pic](https://imgur.com/a/ABFcWWw),
  [pr](https://github.com/ayjays132/phill-cli/pull/8940) by
  [@abhipatel12](https://github.com/abhipatel12)).
- **Model routing:** Phill CLI will now intelligently pick the best model for
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/9262) by
  [@abhipatel12](https://github.com/abhipatel12)).
  - Discussion:
    [https://github.com/ayjays132/phill-cli/discussions/12375](https://github.com/ayjays132/phill-cli/discussions/12375)
- **Codebase investigator subagent:** We now have a new built-in subagent that
  ...
  overall performance.
  ([pr](https://github.com/ayjays132/phill-cli/pull/9988) by
  [@abhipatel12](https://github.com/abhipatel12),
  [pr](https://github.com/ayjays132/phill-cli/pull/10282) by
  ...
  - Enable, disable, or limit turns in `/settings`, plus advanced configs in
    ...
    [pr](https://github.com/ayjays132/phill-cli/pull/10844) by
    [@silviojr](https://github.com/silviojr)).
- **Explore extensions with `/extension`:** Users can now open the extensions
  ...
  explore command. ([pr](https://github.com/ayjays132/phill-cli/pull/11846)
...
- **Configurable compression:** Users can modify the compression threshold in
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/12317) by
  [@scidomino](https://github.com/scidomino)).
- **API key authentication:** Users can now securely enter and store their
  Phill API key via a new dialog, eliminating the need for environment
  variables and repeated entry.
  ([pr](https://github.com/ayjays132/phill-cli/pull/11760) by
  [@galz10](https://github.com/galz10)).
- **Sequential approval:** Users can now approve multiple tool calls
  sequentially during execution.
  ([pr](https://github.com/ayjays132/phill-cli/pull/11593) by
  [@joshualitt](https://github.com/joshualitt)).

## Announcements: v0.11.0 - 2025-10-20

![Phill CLI and Jules](https://storage.googleapis.com/gweb-developer-goog-blog-assets/images/Jules_Extension_-_Blog_Header_O346JNt.original.png)

- 🎉 **Phill CLI Jules Extension:** Use Phill CLI to orchestrate Jules. Spawn
  remote workers, delegate tedious tasks, or check in on running jobs!
  - Install:
    `phill extensions install https://github.com/phill-cli-extensions/jules`
  - Announcement:
...
- **Stream JSON output:** Stream real-time JSONL events with
  ...
  [pr](https://github.com/ayjays132/phill-cli/pull/10883) by
  [@anj-s](https://github.com/anj-s))
- **Markdown toggle:** Users can now switch between rendered and raw markdown
  ...
  [pr](https://github.com/ayjays132/phill-cli/pull/10383) by
...
- **Queued message editing:** Users can now quickly edit queued messages by
  ...
  [pr](https://github.com/ayjays132/phill-cli/pull/10392) by
...
- **JSON web fetch**: Non-HTML content like JSON APIs or raw source code are now
  ...
  [pr](https://github.com/ayjays132/phill-cli/pull/11284) by
  [@abhipatel12](https://github.com/abhipatel12))
- **Non-interactive MCP commands:** Users can now run MCP slash commands in
  non-interactive mode `phill "/some-mcp-prompt"`.
  ([pr](https://github.com/ayjays132/phill-cli/pull/10194) by
  [@capachino](https://github.com/capachino))
- **Removal of deprecated flags:** We’ve finally removed a number of deprecated
  flags to cleanup Phill CLI’s invocation profile:
  - `--all-files` / `-a` in favor of `@` from within Phill CLI.
    ([pr](https://github.com/ayjays132/phill-cli/pull/11228) by
    [@allenhutchison](https://github.com/allenhutchison))
  - `--telemetry-*` flags in favor of
    [environment variables](https://github.com/ayjays132/phill-cli/pull/11318)
    ([pr](https://github.com/ayjays132/phill-cli/pull/11318) by
    [@allenhutchison](https://github.com/allenhutchison))
...
- **Interactive Shell Tool calling:** Phill CLI can now also execute
  interactive tools if needed
  ([pr](https://github.com/ayjays132/phill-cli/pull/11225) by
  [@galz10](https://github.com/galz10)).
- **Alt+Key support:** Enables broader support for Alt+Key keyboard shortcuts
  across different terminals.
  ([pr](https://github.com/ayjays132/phill-cli/pull/10767) by
  [@srivatsj](https://github.com/srivatsj)).
- **Telemetry Diff stats:** Track line changes made by the model and user during
  file operations via OTEL.
  ([pr](https://github.com/ayjays132/phill-cli/pull/10819) by
...
- 🎉 **Interactive Shell:** Run interactive commands like `vim`, `rebase -i`, or
  even `phill` 😎 directly in Phill CLI:
  - Blog:
...
- **Install pre-release extensions:** Install the latest `--pre-release`
  ...
  marked as "latest".
  ([pr](https://github.com/ayjays132/phill-cli/pull/10752) by
  [@jakemac53](https://github.com/jakemac53))
- **Simplified extension creation:** Create a new, empty extension. Templates
  are no longer required.
  ([pr](https://github.com/ayjays132/phill-cli/pull/10629) by
...
- **OpenTelemetry GenAI metrics:** Aligns telemetry with industry-standard
  ...
  [pr](https://github.com/ayjays132/phill-cli/pull/10343) by
  [@jerop](https://github.com/jerop))
- **List memory files:** Quickly find the location of your long-term memory
  files with `/memory list`.
  ([pr](https://github.com/ayjays132/phill-cli/pull/10108) by
  [@sgnagnarella](https://github.com/sgnagnarella))

## Announcements: v0.8.0 - 2025-09-29

- 🎉 **Announcing Phill CLI Extensions** 🎉
  - Completely customize your Phill CLI experience to fit your workflow.
  - Build and share your own Phill CLI extensions with the world.
  - Launching with a growing catalog of community, partner, and Google-built
    extensions.
    - Check extensions from
      [key launch partners](https://github.com/ayjays132/phill-cli/discussions/10718).
  - Easy install:
    - `phill extensions install <github url|folder path>`
  - Easy management:
    - `phill extensions install|uninstall|link`
    - `phill extensions enable|disable`
    - `phill extensions list|update|new`
  - Or use commands while running with `/extensions list|update`.
  - Everything you need to know:
    [Now open for building: Introducing Phill CLI extensions](https://blog.google/technology/developers/gemini-cli-extensions/).
- 🎉 **Our New Home Page & Better Documentation** 🎉
  ...
  - _Homepage:_ [https://phillcli.com](https://phillcli.com)
  - ‼️*NEW documentation:*
    [https://phillcli.com/docs](https://phillcli.com/docs) (Have any
    [suggestions](https://github.com/ayjays132/phill-cli/discussions/8722)?)
  - _Extensions:_
    [https://phillcli.com/extensions](https://phillcli.com/extensions)
- **Non-Interactive Allowed Tools:** `--allowed-tools` will now also work in
  non-interactive mode.
  ([pr](https://github.com/ayjays132/phill-cli/pull/9114) by
...
- **Terminal Title Status:** See the CLI's real-time status and thoughts
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/4386) by
...
- 🎉**Build your own Phill CLI IDE plugin:** We've published a spec for
  creating IDE plugins to enable rich context-aware experiences and native
  in-editor diffing in your IDE of choice.
  ([pr](https://github.com/ayjays132/phill-cli/pull/8479) by
  [@skeshive](https://github.com/skeshive))
- 🎉 **Phill CLI extensions**
  - **Flutter:** An early version to help you create, build, test, and run
    Flutter apps with Phill CLI
    ([extension](https://github.com/phill-cli-extensions/flutter))
  - **nanobanana:** Integrate nanobanana into Phill CLI
    ([extension](https://github.com/phill-cli-extensions/nanobanana))
- **Telemetry config via environment:** Manage telemetry settings using
  environment variables for a more flexible setup.
  ([docs](https://github.com/ayjays132/phill-cli/blob/main/docs/cli/telemetry.md#configuration),
  [pr](https://github.com/ayjays132/phill-cli/pull/9113) by
  [@jerop](https://github.com/jerop))
- **​​Experimental todos:** Track and display progress on complex tasks with a
  ...
  `"useWriteTodos": true`
  ([pr](https://github.com/ayjays132/phill-cli/pull/8761) by
  [@anj-s](https://github.com/anj-s))
- **Share chat support for tools:** Using `/chat share` will now also render
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/8693) by
  [@rramkumar1](https://github.com/rramkumar1))
- **Citations:** Now enabled for all users
  ([pr](https://github.com/ayjays132/phill-cli/pull/8570) by
  [@scidomino](https://github.com/scidomino))
- **Custom commands in Headless Mode:** Run custom slash commands directly from
  the command line in non-interactive mode: `phill "/joke Chuck Norris"`
  ([pr](https://github.com/ayjays132/phill-cli/pull/8305) by
  [@capachino](https://github.com/capachino))
- **Small features, polish, reliability & bug fixes:** A large amount of
  changes, smaller features, UI updates, reliability and bug fixes + general
  polish made it in this week!
...
- 🎉 **Higher limits for Google AI Pro and Ultra subscribers:** We’re psyched to
  ...
  significantly higher 2.5 quota limits for Phill CLI!
  - **Announcement:**
...
- 🎉**Phill CLI Databases and BigQuery Extensions:** Connect Phill CLI to all
  of your cloud data with Phill CLI.
  ...
  - **AlloyDB:** Interact, manage and observe AlloyDB for PostgreSQL databases
    ([manage](https://github.com/phill-cli-extensions/alloydb#configuration),
    [observe](https://github.com/phill-cli-extensions/alloydb-observability#configuration))
  - **BigQuery:** Connect and query your BigQuery datasets or utilize a
    sub-agent for contextual insights
    ([query](https://github.com/phill-cli-extensions/bigquery-data-analytics#configuration),
    [sub-agent](https://github.com/phill-cli-extensions/bigquery-conversational-analytics))
  - **Cloud SQL:** Interact, manage and observe Cloud SQL for PostgreSQL
    ([manage](https://github.com/phill-cli-extensions/cloud-sql-postgresql#configuration),[ observe](https://github.com/phill-cli-extensions/cloud-sql-postgresql-observability#configuration)),
    Cloud SQL for MySQL
    ([manage](https://github.com/phill-cli-extensions/cloud-sql-mysql#configuration),[ observe](https://github.com/phill-cli-extensions/cloud-sql-mysql-observability#configuration))
    and Cloud SQL for SQL Server
    ([manage](https://github.com/phill-cli-extensions/cloud-sql-sqlserver#configuration),[ observe](https://github.com/phill-cli-extensions/cloud-sql-sqlserver-observability#configuration))
    databases.
  - **Dataplex:** Discover, manage, and govern data and AI artifacts
    ([extension](https://github.com/phill-cli-extensions/dataplex#configuration))
  - **Firestore:** Interact with Firestore databases, collections and documents
    ([extension](https://github.com/phill-cli-extensions/firestore-native#configuration))
  - **Looker:** Query data, run Looks and create dashboards
    ([extension](https://github.com/phill-cli-extensions/looker#configuration))
  - **MySQL:** Interact with MySQL databases
    ([extension](https://github.com/phill-cli-extensions/mysql#configuration))
  - **Postgres:** Interact with PostgreSQL databases
    ([extension](https://github.com/phill-cli-extensions/postgres#configuration))
  - **Spanner:** Interact with Spanner databases
    ([extension](https://github.com/phill-cli-extensions/spanner#configuration))
  - **SQL Server:** Interact with SQL Server databases
    ([extension](https://github.com/phill-cli-extensions/sql-server#configuration))
  - **MCP Toolbox:** Configure and load custom tools for more than 30+ data
    sources
    ([extension](https://github.com/phill-cli-extensions/mcp-toolbox#configuration))
- **JSON output mode:** Have Phill CLI output JSON with `--output-format json`
  when invoked headlessly for easy parsing and post-processing. Includes
  response, stats and errors.
  ([pr](https://github.com/ayjays132/phill-cli/pull/8119) by
  [@jerop](https://github.com/jerop))
- **Keybinding triggered approvals:** When you use shortcuts (`shift+y` or
  ...
  will now approve. ([pr](https://github.com/ayjays132/phill-cli/pull/6665)
...
- **Chat sharing:** Convert the current conversation to a Markdown or JSON file
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/8139) by
  [@rramkumar1](https://github.com/rramkumar1))
- **Prompt search:** Search your prompt history using `ctrl+r`.
  ([pr](https://github.com/ayjays132/phill-cli/pull/5539) by
...
- **Input undo/redo:** Recover accidentally deleted text in the input prompt
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/4625) by
...
- **Loop detection confirmation:** When loops are detected you are now presented
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/8231) by
...
- **Direct to Google Cloud Telemetry:** Directly send telemetry to Google Cloud
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/8541) by
  [@jerop](https://github.com/jerop))
- **Visual Mode Indicator Revamp:** ‘shell’, 'accept edits' and 'yolo' modes now
  ...
  [pr](https://github.com/ayjays132/phill-cli/pull/8200) by
...
- 🎉**FastMCP + Phill CLI**🎉: Quickly install and manage your Phill CLI MCP
  servers with FastMCP ([video](https://imgur.com/a/m8QdCPh),
  [pr](https://github.com/jlowin/fastmcp/pull/1709) by
  [@jackwotherspoon](https://github.com/jackwotherspoon)**)**
  - Getting started:
    [https://gofastmcp.com/integrations/phill-cli](https://gofastmcp.com/integrations/phill-cli)
- **Positional Prompt for Non-Interactive:** Seamlessly invoke Phill CLI
  headlessly via `phill "Hello"`. Synonymous with passing `-p`.
  ([gif](https://imgur.com/a/hcBznpB),
  [pr](https://github.com/ayjays132/phill-cli/pull/7668) by
  [@allenhutchison](https://github.com/allenhutchison))
- **Experimental Tool output truncation:** Enable truncating shell tool outputs
  and saving full output to a file by setting
  `"enableToolOutputTruncation": true `([pr](https://github.com/ayjays132/phill-cli/pull/8039)
  by [@SandyTao520](https://github.com/SandyTao520))
- **Edit Tool improvements:** Phill CLI’s ability to edit files should now be
  far more capable. ([pr](https://github.com/ayjays132/phill-cli/pull/7679)
...
- **Custom witty messages:** The feature you’ve all been waiting for…
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/7641) by
  [@JayadityaGit](https://github.com/JayadityaGit))
- **Nested .gitignore File Handling:** Nested `.gitignore` files are now
  respected. ([pr](https://github.com/ayjays132/phill-cli/pull/7645) by
...
- **Enforced authentication:** System administrators can now mandate a specific
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/6564) by
  [@chrstnb](https://github.com/chrstnb))
- **A2A development-tool extension:** An RFC for an Agent2Agent
  ...
  use cases.
  ([feedback](https://github.com/ayjays132/phill-cli/discussions/7822),
  [pr](https://github.com/ayjays132/phill-cli/pull/7817) by
  [@skeshive](https://github.com/skeshive))
- **Hands on Codelab:
...
- 🎉**Phill CLI CloudRun and Security Integrations**🎉: Automate app deployment
...
- **Experimental**
  - **Edit Tool:** Give our new edit tool a try by setting
    ...
    ([feedback](https://github.com/ayjays132/phill-cli/discussions/7758),
    [pr](https://github.com/ayjays132/phill-cli/pull/6823) by
    [@silviojr](https://github.com/silviojr))
  - **Model talking to itself fix:** We’ve removed a model workaround that would
    encourage Phill CLI to continue conversations on your behalf. This may be
    disruptive and can be disabled via `"skipNextSpeakerCheck": false` in your
    `settings.json`
    ([feedback](https://github.com/ayjays132/phill-cli/discussions/6666),
    [pr](https://github.com/ayjays132/phill-cli/pull/7614) by
    [@SandyTao520](https://github.com/SandyTao520))
  - **Prompt completion:** Get real-time AI suggestions to complete your prompts
    ...
    [pr](https://github.com/ayjays132/phill-cli/pull/4691) by
    [@3ks](https://github.com/3ks))
- **Footer visibility configuration:** Customize the CLI's footer look and feel
  in `settings.json`
  ([pr](https://github.com/ayjays132/phill-cli/pull/7419) by
  [@miguelsolorio](https://github.com/miguelsolorio))
...
- **Citations:** For enterprise Code Assist licenses users will now see
  ...
  `"showCitations": true`
  ([pr](https://github.com/ayjays132/phill-cli/pull/7350) by
  [@scidomino](https://github.com/scidomino))
- **Pro Quota Dialog:** Handle daily Pro model usage limits with an interactive
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/7094) by
  [@JayadityaGit](https://github.com/JayadityaGit))
...
- **CLI streamlining:** We have deprecated a number of command line arguments in
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/7360) by
  [@allenhutchison](https://github.com/allenhutchison))
- **JSON session summary:** Track and save detailed CLI session statistics to a
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/7347) by
...
- **Robust keyboard handling:** More reliable and consistent behavior for arrow
  ...
  terminals. ([pr](https://github.com/ayjays132/phill-cli/pull/7118) by
...
- **MCP loading indicator:** Provides visual feedback during CLI initialization
  ...
  ([pr](https://github.com/ayjays132/phill-cli/pull/6923) by
