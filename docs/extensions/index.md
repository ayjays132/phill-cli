...
Phill CLI extensions package prompts, MCP servers, custom commands, hooks,
sub-agents, and agent skills into a familiar and user-friendly format. With
extensions, you can expand the capabilities of Phill CLI and share those
...
[Phill CLI extensions](https://phillcli.com/extensions/browse/).
