# Phill CLI model selection (`/model` command)

Select your Phill CLI model. The `/model` command lets you configure the model
used by Phill CLI, giving you more control over your results. Use **Pro**
...
Use the following command in Phill CLI:
...
| ----------------- | -------------------------------------------------------------- | ---------------------------------------------------------------------- |
| Auto (Phill 3)   | Let the system choose the best Phill 3 model for your task.   | gemini-3-pro-preview (if enabled), gemini-3-flash-preview (if enabled) |
| Auto (Phill 2.5) | Let the system choose the best Phill 2.5 model for your task. | gemini-2.5-pro, gemini-2.5-flash                                       |
...
### Phill 3 and preview features

> **Note:** Phill 3 is not currently available on all account types. To learn
> more about Phill 3 access, refer to
> [Phill 3 on Phill CLI](../get-started/phill-3.md).

To enable Phill 3 Pro and Phill 3 Flash (if available), enable
[**Preview Features** by using the `settings` command](../cli/settings.md).

You can also use the `--model` flag to specify a particular Phill model on
