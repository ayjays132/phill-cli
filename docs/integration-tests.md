...
the Phill CLI. They execute the built binary in a controlled environment and
...
any information about yourself or your system that phill may have included in
these responses.
...
The workflow runs the tests in different sandboxing environments to ensure Phill
