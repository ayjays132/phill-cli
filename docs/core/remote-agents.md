...
Phill CLI supports connecting to remote subagents using the Agent-to-Agent
(A2A) protocol. This allows Phill CLI to interact with other agents, expanding
its capabilities by delegating tasks to remote services.

Phill CLI can connect to any compliant A2A agent. You can find samples of A2A
...
Users can manage subagents using the following commands within the Phill CLI:
...
> **Tip:** You can use the `@cli_help` agent within Phill CLI for assistance
