...
function generateMarkdown(currentStatsByModel, history) {
  ...
  console.log(
    'See [evals/README.md](https://github.com/ayjays132/phill-cli/tree/main/evals) for more details.\n',
  );
  ...
  for (const model of models) {
    ...
    for (const name of Array.from(allTestNames).sort()) {
      const searchUrl = `https://github.com/search?q=repo%3Aayjays132%2Fgemini-cli%20%22${encodeURIComponent(name)}%22&type=code`;
