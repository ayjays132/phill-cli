...
const REPO = 'google-phill/phill-cli';
const MAINTAINERS_REPO = 'google-phill/maintainers-phill-cli';
...
async function run() {
  ...
  console.log(`
Total Open Phill Issues: ${issues.length}`);
  ...
  for (const item of currentItems) {
    ...
    if (
      ...
      (item.content.url && item.content.url.includes('maintainers-phill-cli'))
    ) {
      continue;
    }
