...
const SCHEMA_ID = 'https://raw.githubusercontent.com/ayjays132/phill-cli/main/schemas/settings.schema.json';
...
function buildSchemaObject(schema) {
    ...
    const root = {
        ...
        $id: SCHEMA_ID,
        title: 'Phill CLI Settings',
        description: 'Configuration file schema for Phill CLI settings. This schema enables IDE completion for `settings.json`.',
        type: 'object',
