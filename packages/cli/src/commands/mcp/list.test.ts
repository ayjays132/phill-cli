...
import { createTransport, debugLogger } from 'phill-cli-core';
  ...
  return {
    ...
    Storage: Object.assign(
      vi.fn().mockImplementation((_cwd: string) => ({
        getGlobalSettingsPath: () => '/tmp/phill/settings.json',
        getWorkspaceSettingsPath: () => '/tmp/phill/workspace-settings.json',
        getProjectTempDir: () => '/test/home/.phill/tmp/mocked_hash',
      })),
      {
        getGlobalSettingsPath: () => '/tmp/phill/settings.json',
      },
