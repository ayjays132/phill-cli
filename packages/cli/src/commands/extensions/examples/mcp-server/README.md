...
Phill CLI extension. It demonstrates how to expose tools and prompts to the
Phill CLI.
...
- `phill-extension.json`: The configuration file that tells Phill CLI how to
  use this extension.
...
This example is typically used by `phill extensions new`.
