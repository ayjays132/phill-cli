...
export const defaultKeyBindings: KeyBindingConfig = {
  ...
  [Command.SHOW_FULL_TODOS]: [{ key: 't', alt: true, ctrl: false }],
  [Command.SHOW_IDE_CONTEXT_DETAIL]: [{ key: 'g', alt: true }],
...
export const commandDescriptions: Readonly<Record<Command, string>> = {
  ...
  [Command.FOCUS_SHELL_INPUT]: 'Focus the shell input from the phill input.',
  [Command.UNFOCUS_SHELL_INPUT]: 'Focus the Phill input from the shell input.',
