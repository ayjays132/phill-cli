...
const SETTINGS_SCHEMA = {
  ...
  general: {
    ...
    properties: {
      ...
      retryOnRateLimit: {
        ...
        default: true,
        description:
          'Automatically retry rate-limited requests every 2 minutes while quota dialog is active.',
        showInDialog: true,
      },
      ...
      heartbeat: {
        ...
        default: {},
        description:
          'Background heartbeat that can periodically send a continuation prompt while idle.',
        showInDialog: false,
        properties: {
          enabled: {
            type: 'boolean',
            ...
            default: false,
            description:
              'Enable periodic background continuation prompts while idle.',
            showInDialog: true,
          },
          intervalSeconds: {
            type: 'number',
            ...
            default: 300,
            description:
              'Interval in seconds between heartbeat continuation prompts (minimum 10).',
            showInDialog: true,
          },
          prompt: {
            type: 'string',
            ...
            default: 'continue',
            description:
              'Prompt text sent by heartbeat when it fires (for example: "continue").',
            showInDialog: true,
          },
        },
      },
  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show Phill CLI model thoughts in the terminal window title during the working phase',
        showInDialog: true,
      },
      dynamicWindowTitle: {
        type: 'boolean',
      ...
      showHomeDirectoryWarning: {
        ...
        default: true,
        description:
          'Show a warning when running Phill CLI in the home directory.',
        showInDialog: true,
      },
      hideTips: {
        type: 'boolean',
      ...
      hideContextSummary: {
        ...
        default: false,
        description:
          'Hide the context summary (PHILL.md, MCP servers) above the input.',
        showInDialog: true,
      },
      footer: {
        type: 'object',
      ...
      cognitiveEngine: {
        type: 'object',
        label: 'Meta-Cognition Engine',
        category: 'UI',
        requiresRestart: true,
        default: {},
        description: 'Settings for the background meta-cognition engine (Cognitive Line).',
        showInDialog: false,
        properties: {
          enabled: {
            type: 'boolean',
            label: 'Enable Cognitive Engine',
            category: 'UI',
            requiresRestart: true,
            default: true,
      ...
      voice: {
        ...
        requiresRestart: false,
        default: {},
        description: 'Voice and TTS settings.',
        showInDialog: false,
        properties: {
          enabled: {
            type: 'boolean',
          ...
          captureOutputLoopback: {
            type: 'boolean',
            label: 'Capture Output Loopback',
            category: 'UI',
            requiresRestart: false,
            default: false,
            description:
              'Capture speaker output back into voice input path for full duplex conversational audio setups.',
            showInDialog: true,
          },
          noiseSuppression: {
            type: 'boolean',
            ...
            default: true,
            description:
              'Enable real-time background noise suppression for microphone capture.',
            showInDialog: true,
          },
          ...
          autoGainControl: {
            ...
            default: true,
            description:
              'Enable automatic gain leveling so quieter voices remain intelligible.',
            showInDialog: true,
          },
          highpassFilter: {
            type: 'boolean',
            ...
            default: true,
            description:
              'Reduce low-frequency rumble and HVAC hum from microphone capture.',
            showInDialog: true,
          },
          voiceIsolationMode: {
            type: 'enum',
            label: 'Voice Isolation Mode',
            category: 'UI',
            requiresRestart: false,
            default: 'standard',
            description:
              'Speech-focused cleanup profile. Aggressive removes more background noise but can color voice tone.',
            showInDialog: true,
            options: [
              { value: 'off', label: 'Off' },
              { value: 'standard', label: 'Standard' },
          ...
          waiterEnabled: {
            type: 'boolean',
            label: 'Voice Waiter Tool',
            category: 'UI',
            requiresRestart: false,
            default: true,
            description:
              'Enable persistent voice waiter tool so model can wait/listen/respond naturally in voice mode.',
            showInDialog: true,
          },
          realtimeConversation: {
            ...
            default: true,
            description:
              'Keep a continuous listen/respond loop while voice mode is active.',
            showInDialog: true,
          },
          minUserSilenceMs: {
            type: 'number',
            label: 'Min User Silence (ms)',
            category: 'UI',
            requiresRestart: false,
            default: 450,
            description:
              'Minimum silence window before finalizing speech for submission.',
            showInDialog: true,
          },
          responseDelayMs: {
            type: 'number',
            ...
            default: 120,
            description:
              'Small delay before sending finalized transcript to model.',
            showInDialog: true,
          },
          preferredGender: {
            type: 'enum',
            ...
            default: 'auto',
            description:
              'Preferred TTS persona. Auto uses agent identity values first.',
            showInDialog: true,
            options: [
          ...
          preferredStyle: {
            ...
            default: '',
            description:
              'Optional TTS speaking style (e.g. calm, cheerful, empathetic).',
            showInDialog: true,
          },
          ttsProvider: {
            type: 'enum',
            ...
            default: 'auto',
            description:
              'Select TTS backend. Pocket is local fallback-friendly. If setup was skipped, run /voice setup anytime.',
            showInDialog: true,
            options: [
              { value: 'auto', label: 'Auto' },
              { value: 'pocket', label: 'Pocket TTS' },
          ...
          preferAuthTtsProvider: {
            type: 'boolean',
            label: 'Prefer Auth Provider',
            category: 'UI',
            requiresRestart: false,
            default: true,
            description:
              'If enabled, Gemini/OpenAI auth can be prioritized over legacy Pocket selection while still keeping Pocket fallback.',
            showInDialog: true,
          },
          geminiApiKey: {
            type: 'string',
            ...
            default: '',
            description:
              'Optional voice-only Gemini API key override for TTS. If empty, existing auth/global Gemini keys are used.',
            showInDialog: true,
          },
          geminiVoiceName: {
            type: 'string',
            ...
            default: '',
            description:
              'Optional Gemini TTS voice override (e.g. Kore, Puck, Charon).',
            showInDialog: true,
          },
          geminiTtsModel: {
            type: 'string',
          ...
          openAiApiKey: {
            ...
            default: '',
            description:
              'Optional voice-only OpenAI API key override for TTS. If empty, existing OpenAI API key settings are used.',
            showInDialog: true,
          },
          openAiVoice: {
            type: 'string',
            ...
            default: '',
            description:
              'Optional OpenAI TTS voice name override (this is not an API key). Configure API key separately via auth/settings (OPENAI_API_KEY).',
            showInDialog: true,
          },
          openAiTtsModel: {
            type: 'string',
          ...
          elevenLabsApiKey: {
            ...
            default: '',
            description:
              'Optional voice-only ElevenLabs API key override. If empty, ELEVENLABS_API_KEY env var is used.',
            showInDialog: true,
          },
          elevenLabsVoiceId: {
            type: 'string',
            ...
            default: '',
            description:
              'Default ElevenLabs voice ID for speech output (not an API key). API key is ELEVENLABS_API_KEY.',
            showInDialog: true,
          },
          elevenLabsModelId: {
            type: 'string',
          ...
          elevenLabsOutputFormat: {
            ...
            requiresRestart: false,
            default: 'pcm_24000',
            description: 'ElevenLabs output format (for example pcm_24000, mp3_44100_128).',
            showInDialog: true,
          },
          elevenLabsStability: {
            type: 'number',
          ...
          huggingFaceApiKey: {
            type: 'string',
            label: 'Hugging Face TTS Key',
            category: 'UI',
            requiresRestart: false,
            default: '',
            description:
              'Optional voice-only Hugging Face key override for Pocket TTS model access. If empty, existing Hugging Face settings/env are used.',
            showInDialog: true,
          },
          pocketVoicePreset: {
            type: 'enum',
            label: 'Pocket Voice Preset',
            category: 'UI',
            requiresRestart: false,
            default: 'alba',
            description:
              'Preferred Pocket TTS preset voice (used when Pocket provider is active).',
            showInDialog: true,
            options: [
          ...
          pocketReferenceAudio: {
            type: 'string',
            label: 'Pocket Reference Audio',
            category: 'UI',
            requiresRestart: false,
            default: 'Voices/voice_preview_aria.mp3',
            description:
              'Reference file for Pocket voice cloning. Defaults to voice_preview_aria.mp3 if present.',
            showInDialog: true,
          },
          pocketModelId: {
            type: 'string',
            label: 'Pocket Model ID',
            category: 'UI',
            requiresRestart: false,
            default: 'kyutai/pocket-tts',
            description:
              'Hugging Face model ID used by Pocket TTS via Transformers.js.',
            showInDialog: true,
          },
          pocketModelDir: {
            type: 'string',
            label: 'Pocket Model Directory',
            category: 'UI',
            requiresRestart: false,
            default: '',
            description:
              'Optional local model cache directory for Pocket TTS. Leave empty to use the default model cache path. Download/setup with /voice setup.',
            showInDialog: true,
          },
          pocketCommand: {
            type: 'string',
            label: 'Pocket Command',
            category: 'UI',
            requiresRestart: false,
            default: 'pocket-tts',
            description:
              'Executable name/path for Pocket TTS CLI.',
            showInDialog: false,
          },
          vadThreshold: {
            type: 'number',
            ...
            default: 500,
            description:
              'Voice Activity Detection threshold (RMS amplitude 0-32768).',
            showInDialog: true,
          },
        },
      },
  ...
  signal: {
    ...
    properties: {
      ...
      trustedNumbers: {
        ...
        requiresRestart: false,
        default: [],
        description: 'List of phone numbers allowed to send remote commands to this Phill CLI.',
        showInDialog: true,
      },
    },
  },
  ...
  huggingFace: {
    ...
    requiresRestart: true,
    default: {},
    description: 'Configuration for HuggingFace models.',
    showInDialog: false,
    properties: {
      endpoint: {
        type: 'string',
        ...
        category: 'Model',
        requiresRestart: true,
        default: undefined as string | undefined, // Optional, defaults to inference API if not set
  ...
  openAI: {
    ...
    default: {},
    description:
      'Configuration for OpenAI-compatible API models (OpenAI/Codex).',
    showInDialog: false,
    properties: {
      endpoint: {
        type: 'string',
  ...
  anthropic: {
    ...
    requiresRestart: true,
    default: {},
    description: 'Configuration for Anthropic Claude models.',
    showInDialog: false,
    properties: {
      endpoint: {
        type: 'string',
  ...
  groq: {
    ...
    requiresRestart: true,
    default: {},
    description: 'Configuration for Groq (OpenAI-compatible) models.',
    showInDialog: false,
    properties: {
      endpoint: {
        type: 'string',
  ...
  xai: {
    ...
    requiresRestart: true,
    default: {},
    description: 'Configuration for xAI Grok models.',
    showInDialog: false,
    properties: {
      endpoint: {
        type: 'string',
  ...
  customApi: {
    ...
    requiresRestart: true,
    default: {},
    description: 'Configuration for custom OpenAI-compatible API endpoints.',
    showInDialog: false,
    properties: {
      endpoint: {
        type: 'string',
  ...
  context: {
    ...
    properties: {
      ...
      loadMemoryFromIncludeDirectories: {
        ...
        default: false,
        description: oneLine`
          Controls how /memory refresh loads PHILL.md files.
      ...
      fileFiltering: {
        ...
        properties: {
          ...
          customIgnoreFilePaths: {
            ...
            default: [] as string[],
            description:
              'Additional ignore file paths to respect. These files take precedence over .phillignore and .gitignore. Files earlier in the array take precedence over files later in the array, e.g. the first file takes precedence over the second one.',
            showInDialog: true,
            items: { type: 'string' },
  ...
  webSearch: {
    ...
    requiresRestart: false,
    default: {},
    description: 'Advanced Google Search settings.',
    showInDialog: false,
    properties: {
      deepResearchByDefault: {
        type: 'boolean',
        label: 'Deep Research by Default',
        category: 'Tools',
        requiresRestart: false,
        default: false,
        description: 'Perform autonomous deep research synthesis by default for every search.',
        showInDialog: true,
      },
      includeIdeContext: {
        type: 'boolean',
        label: 'Include IDE Context',
        category: 'Tools',
        requiresRestart: false,
        default: true,
        description: 'Automatically include selected IDE code as context for search queries.',
        showInDialog: true,
      },
      maxDeepResearchSources: {
        type: 'number',
        label: 'Max Deep Research Sources',
        category: 'Tools',
        requiresRestart: false,
        default: 3,
        description: 'Maximum number of top results to fetch and synthesize during deep research.',
        showInDialog: true,
      },
    },
  },
  ...
  security: {
    ...
    properties: {
      ...
      autoApproveAllActionsForever: {
        type: 'boolean',
        label: 'Auto-Approve All Actions Forever',
        category: 'Security',
        requiresRestart: false,
        default: false,
        description: oneLine`
          If enabled, Phill starts in full auto-approve mode (YOLO) for trusted folders.
          High risk: commands and tool actions can execute without prompts.
        `,
        showInDialog: true,
      },
      blockGitExtensions: {
...
> = {
  MCPServerConfig: {
    ...
    properties: {
      ...
      extension: {
        type: 'object',
        description:
          'Metadata describing the Phill CLI extension that owns this MCP server.',
  ...
  TelemetrySettings: {
    type: 'object',
    description: 'Telemetry configuration for Phill CLI.',
    additionalProperties: false,
    properties: {
      enabled: {
        type: 'boolean',
  ...
  CustomTheme: {
    type: 'object',
    description:
      'Custom theme definition used for styling Phill CLI output. Colors are provided as hex strings or named ANSI colors.',
    additionalProperties: false,
    properties: {
      type: {
        type: 'string',
