...
import { FatalConfigError, ideContextStore } from 'phill-cli-core';
import {
  describe,
  it,
  expect,
...
describe('Trusted Folders Loading', () => {
  ...
  it('should use PHILL_CLI_TRUSTED_FOLDERS_PATH env var if set', () => {
    const customPath = '/custom/path/to/trusted_folders.json';
    process.env['PHILL_CLI_TRUSTED_FOLDERS_PATH'] = customPath;
    ...
    delete process.env['PHILL_CLI_TRUSTED_FOLDERS_PATH'];
  });
