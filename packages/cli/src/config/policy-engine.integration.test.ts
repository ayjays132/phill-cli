...
describe('Policy Engine Integration Tests', () => {
  describe('Policy configuration produces valid PolicyEngine config', () => {
    ...
    it('should allow write_file to plans directory in Plan mode', async () => {
      ...
      const validPlanPath =
        '/home/user/.phill/tmp/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/plans/my-plan.md';
      expect(
        (
          await engine.check(
      ...
      const validPlanPath2 =
        '/home/user/.phill/tmp/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/plans/feature_auth.md';
      expect(
        (
          await engine.check(
    ...
    it('should deny write_file outside plans directory in Plan mode', async () => {
      ...
      const wrongExtPath =
        '/home/user/.phill/tmp/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/plans/script.js';
      expect(
        (
          await engine.check(
      ...
      const traversalPath =
        '/home/user/.phill/tmp/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/plans/../../../etc/passwd.md';
      expect(
        (
          await engine.check(
      ...
      const shortHashPath = '/home/user/.phill/tmp/abc123/plans/plan.md';
      expect(
        (
          await engine.check(
    ...
    it('should deny write_file to subdirectories in Plan mode', async () => {
      ...
      const subdirPath =
        '/home/user/.phill/tmp/a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2/plans/subdir/plan.md';
      expect(
        (
          await engine.check(
