...
export interface HistoryItemBase {
  text?: string; // Text content for user/phill/info/error messages
}
...
export type HistoryItemPhill = HistoryItemBase & {
  type: 'phill';
  text: string;
};

export type HistoryItemPhillContent = HistoryItemBase & {
  type: 'phill_content';
  text: string;
};
 ...
 * being submitted to the Phill model.
 */
...
/**
 * Defines the result of the slash command processor for its consumer (usePhillStream).
 */
