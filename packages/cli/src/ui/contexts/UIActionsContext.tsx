...
export interface UIActions {
  ...
  handleVoiceSubmit: (value: string) => void;
  ...
  setCognitiveLineState: (state: CognitiveLineState) => void;
  setCognitiveLineSuggestion: (suggestion?: string) => void;
  setGroundingState: (state: 'syncing' | 'synced' | 'stale' | 'none') => void;
}
