...
export const INFORMATIVE_TIPS = [
  ...
  'Choose a specific Phill model for conversations (/settings)…',
  ...
  'Toggle respect for .phillignore files in context (/settings)…',
  ...
  'Show Phill CLI status in the terminal window title (/settings)…',
  ...
  'Toggle the todo list display with Alt+T…',
  ...
  "If you're using an IDE, see the context with Alt+G…",
  ...
  'Create a project-specific PHILL.md file with /init…',
  ...
  'Reload instructional context from PHILL.md files with /memory refresh…',
  'List the paths of the PHILL.md files in use with /memory list…',
  'Choose your Phill model with /model…',
