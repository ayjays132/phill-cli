...
export const GITHUB_WORKFLOW_PATHS = [
  'phill-dispatch/phill-dispatch.yml',
  'phill-assistant/phill-invoke.yml',
  'issue-triage/phill-triage.yml',
  'issue-triage/phill-scheduled-triage.yml',
  'pr-review/phill-review.yml',
];

export const GITHUB_COMMANDS_PATHS = [
  'phill-assistant/phill-invoke.toml',
  'issue-triage/phill-scheduled-triage.toml',
  'issue-triage/phill-triage.toml',
  'pr-review/phill-review.toml',
];
...
// Add Phill CLI specific entries to .gitignore file
export async function updateGitignore(gitRepoRoot: string): Promise<void> {
  const gitignoreEntries = ['.phill/', 'gha-creds-*.json'];
...
export const setupGithubCommand: SlashCommand = {
  ...
  action: async (
    ...
    return {
      ...
      toolArgs: {
        description:
          'Setting up GitHub Actions to triage issues and review PRs with Phill.',
        command,
      },
    };
  },
