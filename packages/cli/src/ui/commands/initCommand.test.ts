...
import type { SubmitPromptActionReturn } from 'phill-cli-core';
...
describe('initCommand', () => {
  ...
  it('should inform the user if PHILL.md already exists', async () => {
  ...
  it('should create PHILL.md and submit a prompt if it does not exist', async () => {
    ...
    expect(fs.writeFileSync).toHaveBeenCalledWith(phillMdPath, '', 'utf8');
    ...
    expect(result.content).toContain(
      'You are an AI agent that brings the power of Phill',
    );
  });
