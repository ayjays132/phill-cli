...
import { getVersion } from 'phill-cli-core';
...
* **IDE Client:** VSCode
`;
    const expectedUrl = `https://github.com/ayjays132/phill-cli/issues/new?template=bug_report.yml&title=A%20test%20bug&info=${encodeURIComponent(expectedInfo)}&problem=A%20test%20bug`;
