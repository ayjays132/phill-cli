  ...
  constructor(
    ...
    this.semanticColors = semanticColors ?? {
      text: {
        ...
        hint: this.colors.Gray,
        dim: this.colors.DarkGray,
      },
      input: {
        cursor: this.colors.AccentBlue,
        border_active: this.colors.AccentBlue,
      },
      suggestions: {
        activeBackground: this.colors.AccentPurple,
        activeForeground: this.colors.Background,
      },
      background: {
  ...
  const semanticColors: SemanticColors = {
    text: {
      ...
      response:
        ...
        colors.Foreground,
      hint: customTheme.text?.secondary ?? colors.Gray,
      dim: colors.DarkGray,
    },
    input: {
      cursor: customTheme.border?.focused ?? colors.AccentBlue,
      border_active: customTheme.border?.focused ?? colors.AccentBlue,
    },
    suggestions: {
      activeBackground:
