...
export const CloudFreePrivacyNotice = ({
    ...
    return (
      <Box flexDirection="column" marginY={1}>
        <Text bold color={theme.text.accent}>
          Phill Code Assist Privacy Notice
        </Text>
        <Newline />
        <Text>
  ...
  return (
    <Box flexDirection="column" marginY={1}>
      <Text bold color={theme.text.accent}>
        Phill Code Assist for Individuals Privacy Notice
      </Text>
      <Newline />
      <Text color={theme.text.primary}>
        This notice and our Privacy Policy
        <Text color={theme.text.link}>[1]</Text> describe how Phill Code Assist
        handles your data. Please read them carefully.
      </Text>
      <Newline />
      <Text color={theme.text.primary}>
        When you use Phill Code Assist for individuals with Phill CLI, Google
