...
describe('useShellCommandProcessor', () => {
  ...
  beforeEach(() => {
    ...
    mockPhillClient = { addHistory: vi.fn() } as unknown as PhillClient;
  ...
  it('should handle successful execution and update history correctly', async () => {
    ...
    expect(mockPhillClient.addHistory).toHaveBeenCalled();
  ...
  it('should handle command abort and display cancelled status', async () => {
    ...
    // to avoid duplication/flickering, as they are handled by usePhillStream.
