...
import { isBinary, ShellExecutionService } from 'phill-cli-core';
...
function addShellCommandToPhillHistory(
        ...
        try {
          ...
          result
            .then((result: ShellExecutionResult) => {
              ...
              // We skip this for cancelled commands because usePhillStream handles the
