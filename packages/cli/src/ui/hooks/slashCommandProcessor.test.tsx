...
const {
  ...
  mockVoiceLoadCommands: vi.fn().mockResolvedValue([]),
...
vi.mock('../../services/VoiceCommandLoader.js', () => ({
  VoiceCommandLoader: vi.fn(() => ({
    loadCommands: mockVoiceLoadCommands,
  })),
}));
...
describe('useSlashCommandProcessor', () => {
  ...
  beforeEach(() => {
    ...
    mockVoiceLoadCommands.mockResolvedValue([]);
  ...
  describe('Action Result Handling', () => {
    ...
    it('should handle "load_history" action', async () => {
      ...
      vi.spyOn(mockConfig, 'getPhillClient').mockReturnValue(mockClient);
