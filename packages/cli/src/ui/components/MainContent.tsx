...
import { MAX_PHILL_MESSAGE_LINES } from '../constants.js';
...
// Limit Phill messages to a very high number of lines to mitigate performance
// issues in the worst case if we somehow get an enormous response from Phill.
    ...
    () =>
      uiState.history.map((h) => (
        <MemoizedHistoryItemDisplay
          ...
          availableTerminalHeightPhill={MAX_PHILL_MESSAGE_LINES}
          key={h.id}
          item={h}
          isPending={false}
