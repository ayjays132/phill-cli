...
import { ApprovalMode, debugLogger } from 'phill-cli-core';
...
describe('InputPrompt', () => {
  ...
  describe('clipboard image paste', () => {
    ...
    it('should handle Ctrl+V when clipboard has an image', async () => {
      ...
      vi.mocked(clipboardUtils.saveClipboardImage).mockResolvedValue(
        '/test/.phill-clipboard/clipboard-123.png',
      );
  ...
  describe('mouse interaction', () => {
    ...
    it('should move cursor on mouse click with plain borders', async () => {
      ...
      // Plain-border mode should handle mouse clicks without breaking rendering.
      await simulateClick(stdin, 10, 2);
      await waitFor(() => {
        expect(stdout.lastFrame()).toContain('hello world');
      });
