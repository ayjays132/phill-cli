...
import { PhillMessage } from './messages/PhillMessage.js';
import { InfoMessage } from './messages/InfoMessage.js';
import { ErrorMessage } from './messages/ErrorMessage.js';
import { ToolGroupMessage } from './messages/ToolGroupMessage.js';
import { PhillMessageContent } from './messages/PhillMessageContent.js';
...
import { getMCPServerStatus } from 'phill-cli-core';
...
interface HistoryItemDisplayProps {
  ...
  availableTerminalHeightPhill?: number;
}
...
export const HistoryItemDisplay: React.FC<HistoryItemDisplayProps> = ({
  ...
  return (
    <Box flexDirection="column" key={itemForDisplay.id} width={terminalWidth}>
      ...
      {itemForDisplay.type === 'phill' && (
        <PhillMessage
          text={itemForDisplay.text}
          isPending={isPending}
          availableTerminalHeight={
            availableTerminalHeightPhill ?? availableTerminalHeight
          }
          terminalWidth={terminalWidth}
        />
      )}
      {itemForDisplay.type === 'phill_content' && (
        <PhillMessageContent
          text={itemForDisplay.text}
          isPending={isPending}
          availableTerminalHeight={
