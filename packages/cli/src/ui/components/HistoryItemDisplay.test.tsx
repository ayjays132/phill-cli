...
describe('<HistoryItemDisplay />', () => {
  ...
  it('renders AboutBox for "about" type', () => {
    ...
    expect(lastFrame()).toContain('About Phill CLI');
  });
  ...
  describe.each([true, false])(
    ...
    (useAlternateBuffer) => {
      ...
      it('should render a truncated phill item', () => {
        const item: HistoryItem = {
          id: 1,
          type: 'phill',
          text: longCode,
      ...
      it('should render a full phill item when using availableTerminalHeightPhill', () => {
        const item: HistoryItem = {
          id: 1,
          type: 'phill',
          text: longCode,
        ...
        const { lastFrame } = renderWithProviders(
          <HistoryItemDisplay
            ...
            terminalWidth={80}
            availableTerminalHeight={10}
            availableTerminalHeightPhill={Number.MAX_SAFE_INTEGER}
          />,
          { useAlternateBuffer },
        );
      ...
      it('should render a truncated phill_content item', () => {
        const item: HistoryItem = {
          id: 1,
          type: 'phill_content',
          text: longCode,
      ...
      it('should render a full phill_content item when using availableTerminalHeightPhill', () => {
        const item: HistoryItem = {
          id: 1,
          type: 'phill_content',
          text: longCode,
