...
import type { ToolCallConfirmationDetails, Config } from 'phill-cli-core';
import {
  renderWithProviders,
  createMockSettings,
...
describe('ToolConfirmationMessage', () => {
  ...
  describe('enablePermanentToolApproval setting', () => {
    ...
    it('should show global all-actions options when setting is true', () => {
      const mockConfig = {
        isTrustedFolder: () => true,
        getIdeMode: () => false,
      } as unknown as Config;
      ...
      expect(lastFrame()).toContain('Allow ALL actions for this session');
      expect(lastFrame()).toContain('Allow ALL actions forever');
    });

    it('should show global all-actions options when setting is false', () => {
      const mockConfig = {
        isTrustedFolder: () => true,
        getIdeMode: () => false,
      } as unknown as Config;
