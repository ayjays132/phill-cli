...
describe('keyMatchers', () => {
  ...
  const testCases = [
    ...
    },
    {
      ...
      positive: [createKey('t', { alt: true })],
      negative: [createKey('t'), createKey('t', { ctrl: true })],
    },
    {
      command: Command.SHOW_IDE_CONTEXT_DETAIL,
      positive: [createKey('g', { alt: true })],
      negative: [createKey('g'), createKey('g', { ctrl: true })],
    },
    {
    ...
    {
      command: Command.TOGGLE_TTS,
      positive: [createKey('g', { ctrl: true })],
      negative: [createKey('g'), createKey('g', { alt: true })],
    },
    {
