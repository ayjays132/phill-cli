...
describe('validateNonInterActiveAuth', () => {
  ...
  afterEach(() => {
    if (originalEnvPhillApiKey !== undefined) {
  ...
  it('uses USE_VERTEX_AI if both PHILL_API_KEY and GOOGLE_GENAI_USE_VERTEXAI are set', async () => {
    process.env['PHILL_API_KEY'] = 'fake-key';
    process.env['GOOGLE_GENAI_USE_VERTEXAI'] = 'true';
    process.env['GOOGLE_CLOUD_PROJECT'] = 'test-project';
    process.env['GOOGLE_CLOUD_LOCATION'] = 'us-central1';
  ...
  it('uses USE_PHILL if GOOGLE_GENAI_USE_VERTEXAI is false, PHILL_API_KEY is set, and project/location are available', async () => {
