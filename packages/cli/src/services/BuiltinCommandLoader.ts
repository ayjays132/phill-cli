...
import type { MessageActionReturn, Config } from 'phill-cli-core';
import { isNightly } from 'phill-cli-core';
...
import { heartbeatCommand } from '../ui/commands/heartbeatCommand.js';
import { rewindCommand } from '../ui/commands/rewindCommand.js';
import { hooksCommand } from '../ui/commands/hooksCommand.js';
import { ideCommand } from '../ui/commands/ideCommand.js';
import { initCommand } from '../ui/commands/initCommand.js';
import { identityCommand } from '../ui/commands/identityCommand.js';
...
import { skillForgeCommand } from '../ui/commands/skillForgeCommand.js';
import { forgeCommand } from '../ui/commands/forgeCommand.js';
...
export class BuiltinCommandLoader implements ICommandLoader {
  ...
  async loadCommands(_signal: AbortSignal): Promise<SlashCommand[]> {
    ...
    const allDefinitions: Array<SlashCommand | null> = [
        ...
        helpCommand,
        heartbeatCommand,
        ...(this.config?.isEnableHooksUI() ? [hooksCommand] : []),
        rewindCommand,
        await ideCommand(),
        identityCommand,
        initCommand,
