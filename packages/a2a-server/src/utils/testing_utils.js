 ...
 */
import { ApprovalMode, DEFAULT_GEMINI_MODEL, DEFAULT_TRUNCATE_TOOL_OUTPUT_LINES, DEFAULT_TRUNCATE_TOOL_OUTPUT_THRESHOLD, PhillClient, HookSystem, PolicyDecision, } from 'phill-cli-core';
...
export function createMockConfig(overrides = {}) {
    ...
    mockConfig.getPhillClient = vi
        .fn()
        .mockReturnValue(new PhillClient(mockConfig));
