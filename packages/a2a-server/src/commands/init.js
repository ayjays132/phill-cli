...
export class InitCommand {
    ...
    async handleSubmitPromptResult(result, context, phillMdPath, eventBus, taskId, contextId) {
    ...
    async execute(context, _args = []) {
        ...
        const phillMdPath = path.join(process.env['CODER_AGENT_WORKSPACE_PATH'], 'PHILL.md');
        ...
        switch (result.type) {
            ...
            case 'submit_prompt':
                return this.handleSubmitPromptResult(result, context, phillMdPath, context.eventBus, taskId, contextId);
            default:
