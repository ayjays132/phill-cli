 ...
 */
import { CoreToolScheduler, type PhillClient, type CompletedToolCall, type ToolCallRequestInfo, type ServerPhillStreamEvent, type ToolCallConfirmationDetails, type Config } from 'phill-cli-core';
...
export declare class Task {
    ...
    acceptAgentMessage(event: ServerPhillStreamEvent): Promise<void>;
    ...
    sendCompletedToolsToLlm(completedToolCalls: CompletedToolCall[], aborted: AbortSignal): AsyncGenerator<ServerPhillStreamEvent>;
    acceptUserMessage(requestContext: RequestContext, aborted: AbortSignal): AsyncGenerator<ServerPhillStreamEvent>;
