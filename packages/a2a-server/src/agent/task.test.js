...
import { PhillEventType, ApprovalMode, ToolConfirmationOutcome, } from 'phill-cli-core';
...
describe('Task', () => {
    ...
    describe('acceptAgentMessage', () => {
        ...
        it.each([
            { eventType: PhillEventType.Retry, eventName: 'Retry' },
            { eventType: PhillEventType.InvalidStream, eventName: 'InvalidStream' },
