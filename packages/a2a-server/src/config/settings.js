...
import { debugLogger, PHILL_DIR, getErrorMessage, homedir, } from 'phill-cli-core';
import stripJsonComments from 'strip-json-comments';
export const USER_SETTINGS_DIR = path.join(homedir(), PHILL_DIR);
...
export function loadSettings(workspaceDir) {
    ...
    const workspaceSettingsPath = path.join(workspaceDir, PHILL_DIR, 'settings.json');
