# RFC: Phill CLI A2A Development-Tool Extension

## 1. Introduction

### 1.1 Overview

To standardize client integrations with the Phill CLI agent, this document
...
required for rich, interactive workflows with the Phill CLI agent.

### 1.2 Motivation

Recent work integrating Phill CLI with clients like Zed and Phill Code
...
- **Ecosystem Alignment**: Aligns Phill CLI with a growing industry standard,
...
workflows between a client and the Phill CLI agent. It consists of a
...
```json
{
  "name": "Phill CLI Agent",
  "description": "An agent that generates code based on natural language instructions.",
  "capabilities": {
    "streaming": true,
    "extensions": [
      {
        "uri": "https://github.com/ayjays132/phill-cli/blob/main/docs/a2a/developer-profile/v0/spec.md",
...
// Configuration settings for the Phill CLI agent.
...
This method allows the client to discover slash commands supported by Phill
