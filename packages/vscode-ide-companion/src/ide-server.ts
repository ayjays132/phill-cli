...
} from 'phill-cli-core/src/ide/types.js';
      ...
      this.server = app.listen(0, '127.0.0.1', async () => {
        ...
        if (address && typeof address !== 'string') {
          ...
          try {
            ...
            portFile = path.join(
              portDir,
              `phill-ide-server-${process.ppid}-${this.port}.json`,
            );
...
const createMcpServer = (
  ...
  server.registerTool(
    'openDiff',
    {
      ...
      inputSchema: OpenDiffRequestSchema.shape as any,
    },
  ...
  server.registerTool(
    'closeDiff',
    {
      ...
      inputSchema: CloseDiffRequestSchema.shape as any,
    },
