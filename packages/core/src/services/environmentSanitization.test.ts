...
describe('sanitizeEnvironment', () => {
  ...
  it('should allow variables prefixed with PHILL_CLI_', () => {
    const env = {
      PHILL_CLI_FOO: 'bar',
      PHILL_CLI_BAZ: 'qux',
    };
  ...
  it('should redact variables with values matching all token and credential patterns', () => {
    const env = {
      ...
      STRIPE_RK_LIVE: process.env.STRIPE_RK_LIVE!,
      STRIPE_SK_TEST: process.env.STRIPE_SK_TEST!,
      STRIPE_RK_TEST: process.env.STRIPE_RK_TEST!,
      // Slack
