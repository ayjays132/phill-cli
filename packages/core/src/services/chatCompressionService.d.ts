 ...
 */
export declare const COMPRESSION_PRESERVE_THRESHOLD = 0.15;
/**
...
export declare class ChatCompressionService {
    compress(chat: PhillChat, promptId: string, force: boolean, model: string, config: Config, hasFailedCompressionAttempt: boolean, abortSignal?: AbortSignal): Promise<{
