...
describe('SessionSummaryService', () => {
  ...
  describe('Basic Functionality', () => {
    ...
    it('should handle maxMessages limit correctly', async () => {
      const messages: MessageRecord[] = Array.from({ length: 30 }, (_, i) => ({
        id: `${i}`,
        timestamp: '2025-12-03T00:00:00Z',
        type: i % 2 === 0 ? ('user' as const) : ('phill' as const),
  ...
  describe('Message Type Filtering', () => {
    it('should include only user and phill messages', async () => {
      const messages: MessageRecord[] = [
        {
          id: '1',
          timestamp: '2025-12-03T00:00:00Z',
      ...
      expect(promptText).toContain('Assistant: Phill response');
    });
    ...
    it('should handle mixed message types correctly', async () => {
      ...
      expect(promptText).toContain('Assistant: Phill answer');
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle conversation with only phill messages', async () => {
      const messages: MessageRecord[] = [
        {
          id: '1',
          timestamp: '2025-12-03T00:00:00Z',
