...
export declare function memoryStatus(config: Config): Promise<MessageActionReturn>;
export declare function restoreMemory(config: Config): Promise<MessageActionReturn>;
export declare function resetMemory(config: Config, mode?: 'soft' | 'hard'): Promise<MessageActionReturn>;
