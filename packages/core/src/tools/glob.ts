...
export interface GlobToolParams {
  ...
  /**
   * Whether to respect .phillignore patterns (optional, defaults to true)
   */
    ...
    try {
      ...
      const { filteredPaths, ignoredCount } =
        fileDiscovery.filterFilesWithReport(relativePaths, {
          ...
          respectGeminiIgnore:
            this.params?.respect_phill_ignore ??
      ...
      Kind.Search,
      {
        properties: {
          ...
          respect_phill_ignore: {
            description:
              'Optional: Whether to respect .phillignore patterns when finding files. Defaults to true.',
            type: 'boolean',
          },
        },
        required: ['pattern'],
