...
export interface ReadManyFilesParams {
  ...
  /**
   * Whether to respect .gitignore and .phillignore patterns (optional, defaults to true)
   */
  file_filtering_options?: {
    respect_git_ignore?: boolean;
    respect_phill_ignore?: boolean;
  };
}
 ...
 * This combines the shared patterns with dynamic patterns like PHILL.md.
    ...
    try {
      ...
      const { filteredPaths, ignoredCount } =
        fileDiscovery.filterFilesWithReport(relativeEntries, {
          ...
          respectGeminiIgnore:
            this.params.file_filtering_options?.respect_phill_ignore ??
  ...
  constructor(
    ...
    const parameterSchema = {
      ...
      properties: {
        ...
        file_filtering_options: {
          description:
            'Whether to respect ignore patterns from .gitignore or .phillignore',
          type: 'object',
          properties: {
            respect_git_ignore: {
              description:
            ...
            respect_phill_ignore: {
              description:
                'Optional: Whether to respect .phillignore patterns when listing files. Defaults to true.',
              type: 'boolean',
            },
          },
        },
