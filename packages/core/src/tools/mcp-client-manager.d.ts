 ...
 */
import type { Config, PhillCLIExtension, MCPServerConfig } from '../config/config.js';
...
export declare class McpClientManager {
     ...
     *    - Updates the Phill chat configuration to load the new tools.
     */
    stopExtension(extension: PhillCLIExtension): Promise<void>;
    /**
     * For all the MCP servers associated with this extension:
     *
     ...
     *    - Updates the Phill chat configuration to load the new tools.
     */
    startExtension(extension: PhillCLIExtension): Promise<void>;
    /**
     ...
     * phill settings or command line arguments).
     *
