...
const rootDir = path.resolve(os.tmpdir(), 'phill-cli-test-root');
const plansDir = path.resolve(os.tmpdir(), 'phill-cli-test-plans');
...
const mockConfigInternal = {
  ...
  getPhillClient: vi.fn(), // Initialize as a plain mock function
...
describe('WriteFileTool', () => {
  ...
  beforeEach(() => {
    ...
    // Setup PhillClient mock
    mockPhillClientInstance = new (vi.mocked(PhillClient))(
      mockConfig,
    ) as Mocked<PhillClient>;
    vi.mocked(PhillClient).mockImplementation(() => mockPhillClientInstance);
    ...
    mockConfigInternal.getPhillClient.mockReturnValue(
