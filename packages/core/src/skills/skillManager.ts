...
export class SkillManager {
  ...
  async discoverSkills(
    ...
    debugLogger.log(`Loading user skills from: ${userSkillsDir}`);
    ...
    debugLogger.log(`Loading project skills from: ${projectSkillsDir}`);
  ...
  async reloadSkills(
    ...
    await this.discoverSkills(storage, extensions);
    debugLogger.log('Skills reloaded successfully.');
  }
