...
export const EVENT_CLI_CONFIG = 'phill_cli.config';
export class StartSessionEvent implements BaseTelemetryEvent {
  ...
  constructor(config: Config, toolRegistry?: ToolRegistry) {
    ...
    this.api_key_enabled = usePhill || useVertex;
...
export const EVENT_USER_PROMPT = 'phill_cli.user_prompt';
...
export const EVENT_TOOL_CALL = 'phill_cli.tool_call';
...
export const EVENT_API_REQUEST = 'phill_cli.api_request';
...
export const EVENT_API_ERROR = 'phill_cli.api_error';
...
export const EVENT_API_RESPONSE = 'phill_cli.api_response';
...
export const EVENT_FLASH_FALLBACK = 'phill_cli.flash_fallback';
...
export const EVENT_RIPGREP_FALLBACK = 'phill_cli.ripgrep_fallback';
...
export const EVENT_NEXT_SPEAKER_CHECK = 'phill_cli.next_speaker_check';
...
export const EVENT_SLASH_COMMAND = 'phill_cli.slash_command';
...
export const EVENT_CHAT_COMPRESSION = 'phill_cli.chat_compression';
...
export const EVENT_MALFORMED_JSON_RESPONSE =
  'phill_cli.malformed_json_response';
...
export const EVENT_IDE_CONNECTION = 'phill_cli.ide_connection';
...
export const EVENT_CONVERSATION_FINISHED = 'phill_cli.conversation_finished';
...
export const EVENT_FILE_OPERATION = 'phill_cli.file_operation';
...
export const EVENT_INVALID_CHUNK = 'phill_cli.chat.invalid_chunk';
...
export const EVENT_CONTENT_RETRY = 'phill_cli.chat.content_retry';
...
export const EVENT_CONTENT_RETRY_FAILURE =
  'phill_cli.chat.content_retry_failure';
...
export const EVENT_MODEL_ROUTING = 'phill_cli.model_routing';
...
export const EVENT_EXTENSION_INSTALL = 'phill_cli.extension_install';
...
export const EVENT_TOOL_OUTPUT_TRUNCATED = 'phill_cli.tool_output_truncated';
...
export const EVENT_EXTENSION_UNINSTALL = 'phill_cli.extension_uninstall';
...
export const EVENT_EXTENSION_UPDATE = 'phill_cli.extension_update';
...
export const EVENT_EXTENSION_ENABLE = 'phill_cli.extension_enable';
...
export const EVENT_MODEL_SLASH_COMMAND = 'phill_cli.slash_command.model';
...
export const EVENT_LLM_LOOP_CHECK = 'phill_cli.llm_loop_check';
...
export const EVENT_EXTENSION_DISABLE = 'phill_cli.extension_disable';
...
export const EVENT_EDIT_STRATEGY = 'phill_cli.edit_strategy';
...
export const EVENT_EDIT_CORRECTION = 'phill_cli.edit_correction';
...
export const EVENT_STARTUP_STATS = 'phill_cli.startup_stats';
...
export const EVENT_AGENT_START = 'phill_cli.agent.start';
...
export const EVENT_AGENT_FINISH = 'phill_cli.agent.finish';
...
export const EVENT_AGENT_RECOVERY_ATTEMPT = 'phill_cli.agent.recovery_attempt';
...
export const EVENT_WEB_FETCH_FALLBACK_ATTEMPT =
  'phill_cli.web_fetch_fallback_attempt';
...
export const EVENT_HOOK_CALL = 'phill_cli.hook_call';
