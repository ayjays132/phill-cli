...
export declare const EVENT_CLI_CONFIG = "phill_cli.config";
...
export declare const EVENT_USER_PROMPT = "phill_cli.user_prompt";
...
export declare const EVENT_TOOL_CALL = "phill_cli.tool_call";
...
export declare const EVENT_API_REQUEST = "phill_cli.api_request";
...
export declare const EVENT_API_ERROR = "phill_cli.api_error";
...
export declare const EVENT_API_RESPONSE = "phill_cli.api_response";
...
export declare const EVENT_FLASH_FALLBACK = "phill_cli.flash_fallback";
...
export declare const EVENT_RIPGREP_FALLBACK = "phill_cli.ripgrep_fallback";
...
export declare const EVENT_NEXT_SPEAKER_CHECK = "phill_cli.next_speaker_check";
...
export declare const EVENT_SLASH_COMMAND = "phill_cli.slash_command";
...
export declare const EVENT_CHAT_COMPRESSION = "phill_cli.chat_compression";
...
export declare const EVENT_MALFORMED_JSON_RESPONSE = "phill_cli.malformed_json_response";
...
export declare const EVENT_IDE_CONNECTION = "phill_cli.ide_connection";
...
export declare const EVENT_CONVERSATION_FINISHED = "phill_cli.conversation_finished";
...
export declare const EVENT_FILE_OPERATION = "phill_cli.file_operation";
...
export declare const EVENT_INVALID_CHUNK = "phill_cli.chat.invalid_chunk";
...
export declare const EVENT_CONTENT_RETRY = "phill_cli.chat.content_retry";
...
export declare const EVENT_CONTENT_RETRY_FAILURE = "phill_cli.chat.content_retry_failure";
...
export declare const EVENT_MODEL_ROUTING = "phill_cli.model_routing";
...
export declare const EVENT_EXTENSION_INSTALL = "phill_cli.extension_install";
...
export declare const EVENT_TOOL_OUTPUT_TRUNCATED = "phill_cli.tool_output_truncated";
...
export declare const EVENT_EXTENSION_UNINSTALL = "phill_cli.extension_uninstall";
...
export declare const EVENT_EXTENSION_UPDATE = "phill_cli.extension_update";
...
export declare const EVENT_EXTENSION_ENABLE = "phill_cli.extension_enable";
...
export declare const EVENT_MODEL_SLASH_COMMAND = "phill_cli.slash_command.model";
...
export declare const EVENT_LLM_LOOP_CHECK = "phill_cli.llm_loop_check";
...
export declare const EVENT_EXTENSION_DISABLE = "phill_cli.extension_disable";
...
export declare const EVENT_EDIT_STRATEGY = "phill_cli.edit_strategy";
...
export declare const EVENT_EDIT_CORRECTION = "phill_cli.edit_correction";
...
export declare const EVENT_STARTUP_STATS = "phill_cli.startup_stats";
...
export declare const EVENT_AGENT_START = "phill_cli.agent.start";
...
export declare const EVENT_AGENT_FINISH = "phill_cli.agent.finish";
...
export declare const EVENT_AGENT_RECOVERY_ATTEMPT = "phill_cli.agent.recovery_attempt";
...
export declare const EVENT_WEB_FETCH_FALLBACK_ATTEMPT = "phill_cli.web_fetch_fallback_attempt";
...
export declare const EVENT_HOOK_CALL = "phill_cli.hook_call";
