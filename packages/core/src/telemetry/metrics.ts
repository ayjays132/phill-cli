...
const EVENT_CHAT_COMPRESSION = 'phill_cli.chat_compression';
const TOOL_CALL_COUNT = 'phill_cli.tool.call.count';
const TOOL_CALL_LATENCY = 'phill_cli.tool.call.latency';
const API_REQUEST_COUNT = 'phill_cli.api.request.count';
const API_REQUEST_LATENCY = 'phill_cli.api.request.latency';
const TOKEN_USAGE = 'phill_cli.token.usage';
const SESSION_COUNT = 'phill_cli.session.count';
const FILE_OPERATION_COUNT = 'phill_cli.file.operation.count';
const LINES_CHANGED = 'phill_cli.lines.changed';
const INVALID_CHUNK_COUNT = 'phill_cli.chat.invalid_chunk.count';
const CONTENT_RETRY_COUNT = 'phill_cli.chat.content_retry.count';
const CONTENT_RETRY_FAILURE_COUNT =
  'phill_cli.chat.content_retry_failure.count';
const MODEL_ROUTING_LATENCY = 'phill_cli.model_routing.latency';
const MODEL_ROUTING_FAILURE_COUNT = 'phill_cli.model_routing.failure.count';
const MODEL_SLASH_COMMAND_CALL_COUNT =
  'phill_cli.slash_command.model.call_count';
const EVENT_HOOK_CALL_COUNT = 'phill_cli.hook_call.count';
const EVENT_HOOK_CALL_LATENCY = 'phill_cli.hook_call.latency';

// Agent Metrics
const AGENT_RUN_COUNT = 'phill_cli.agent.run.count';
const AGENT_DURATION_MS = 'phill_cli.agent.duration';
const AGENT_TURNS = 'phill_cli.agent.turns';
const AGENT_RECOVERY_ATTEMPT_COUNT = 'phill_cli.agent.recovery_attempt.count';
const AGENT_RECOVERY_ATTEMPT_DURATION =
  'phill_cli.agent.recovery_attempt.duration';
...
const STARTUP_TIME = 'phill_cli.startup.duration';
const MEMORY_USAGE = 'phill_cli.memory.usage';
const CPU_USAGE = 'phill_cli.cpu.usage';
const TOOL_QUEUE_DEPTH = 'phill_cli.tool.queue.depth';
const TOOL_EXECUTION_BREAKDOWN = 'phill_cli.tool.execution.breakdown';
const TOKEN_EFFICIENCY = 'phill_cli.token.efficiency';
const API_REQUEST_BREAKDOWN = 'phill_cli.api.request.breakdown';
const PERFORMANCE_SCORE = 'phill_cli.performance.score';
const REGRESSION_DETECTION = 'phill_cli.performance.regression';
const REGRESSION_PERCENTAGE_CHANGE =
  'phill_cli.performance.regression.percentage_change';
const BASELINE_COMPARISON = 'phill_cli.performance.baseline.comparison';
const FLICKER_FRAME_COUNT = 'phill_cli.ui.flicker.count';
const SLOW_RENDER_LATENCY = 'phill_cli.ui.slow_render.latency';
const EXIT_FAIL_COUNT = 'phill_cli.exit.fail.count';
