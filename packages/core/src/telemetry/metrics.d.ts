...
declare const EVENT_CHAT_COMPRESSION = "phill_cli.chat_compression";
declare const TOOL_CALL_COUNT = "phill_cli.tool.call.count";
declare const API_REQUEST_COUNT = "phill_cli.api.request.count";
declare const TOKEN_USAGE = "phill_cli.token.usage";
declare const FILE_OPERATION_COUNT = "phill_cli.file.operation.count";
...
declare const STARTUP_TIME = "phill_cli.startup.duration";
declare const MEMORY_USAGE = "phill_cli.memory.usage";
declare const CPU_USAGE = "phill_cli.cpu.usage";
declare const TOOL_EXECUTION_BREAKDOWN = "phill_cli.tool.execution.breakdown";
declare const TOKEN_EFFICIENCY = "phill_cli.token.efficiency";
declare const API_REQUEST_BREAKDOWN = "phill_cli.api.request.breakdown";
declare const PERFORMANCE_SCORE = "phill_cli.performance.score";
declare const REGRESSION_DETECTION = "phill_cli.performance.regression";
declare const BASELINE_COMPARISON = "phill_cli.performance.baseline.comparison";
declare const COUNTER_DEFINITIONS: {
    readonly "phill_cli.tool.call.count": {
        readonly description: "Counts tool calls, tagged by function name and success.";
        readonly valueType: any;
        readonly assign: (c: Counter) => Counter;
        readonly attributes: {
    ...
    readonly "phill_cli.api.request.count": {
    ...
    readonly "phill_cli.token.usage": {
    ...
    readonly "phill_cli.lines.changed": {
    ...
    readonly "phill_cli.slash_command.model.call_count": {
    ...
    readonly "phill_cli.chat_compression": {
    ...
    readonly "phill_cli.agent.run.count": {
    ...
    readonly "phill_cli.agent.recovery_attempt.count": {
...
declare const HISTOGRAM_DEFINITIONS: {
    readonly "phill_cli.tool.call.latency": {
        readonly description: "Latency of tool calls in milliseconds.";
        readonly unit: "ms";
        readonly valueType: any;
        readonly assign: (h: Histogram) => Histogram;
        readonly attributes: {
            function_name: string;
        };
    };
    readonly "phill_cli.api.request.latency": {
    ...
    readonly "phill_cli.model_routing.latency": {
    ...
    readonly "phill_cli.agent.duration": {
    ...
    readonly "phill_cli.ui.slow_render.latency": {
    ...
    readonly "phill_cli.agent.turns": {
    ...
    readonly "phill_cli.agent.recovery_attempt.duration": {
    ...
    readonly "phill_cli.hook_call.latency": {
        readonly description: "Latency of hook calls in milliseconds.";
        readonly unit: "ms";
        readonly valueType: any;
        readonly assign: (c: Histogram) => Histogram;
        readonly attributes: {
            hook_event_name: string;
            hook_name: string;
            success: boolean;
...
declare const PERFORMANCE_COUNTER_DEFINITIONS: {
    readonly "phill_cli.performance.regression": {
...
declare const PERFORMANCE_HISTOGRAM_DEFINITIONS: {
    readonly "phill_cli.startup.duration": {
    ...
    readonly "phill_cli.memory.usage": {
    ...
    readonly "phill_cli.tool.queue.depth": {
    ...
    readonly "phill_cli.tool.execution.breakdown": {
    ...
    readonly "phill_cli.token.efficiency": {
    ...
    readonly "phill_cli.api.request.breakdown": {
    ...
    readonly "phill_cli.performance.score": {
    ...
    readonly "phill_cli.performance.regression.percentage_change": {
    ...
    readonly "phill_cli.performance.baseline.comparison": {
