...
export type ClientMetadataIdeType = 'IDE_UNSPECIFIED' | 'VSCODE' | 'INTELLIJ' | 'VSCODE_CLOUD_WORKSTATION' | 'INTELLIJ_CLOUD_WORKSTATION' | 'CLOUD_SHELL' | 'PHILL_CLI';
export type ClientMetadataPlatform = 'PLATFORM_UNSPECIFIED' | 'DARWIN_AMD64' | 'DARWIN_ARM64' | 'LINUX_AMD64' | 'LINUX_ARM64' | 'WINDOWS_AMD64';
export type ClientMetadataPluginType = 'PLUGIN_UNSPECIFIED' | 'CLOUD_CODE' | 'GEMINI' | 'AIPLUGIN_INTELLIJ' | 'AIPLUGIN_STUDIO' | 'PHILL';
...
export interface LoadCodeAssistResponse {
    currentTier?: PhillUserTier | null;
    allowedTiers?: PhillUserTier[] | null;
    ineligibleTiers?: IneligibleTier[] | null;
    cloudaicompanionProject?: string | null;
}
/**
 * PhillUserTier reflects the structure received from the CodeAssist when calling LoadCodeAssist.
 */
export interface PhillUserTier {
    id: UserTierId;
    name?: string;
    description?: string;
...
/**
 * Status of user onboarded to phill
 */
...
export declare const FetchAdminControlsResponseSchema: any;
export {};
