...
export declare class PhillClient {
    ...
    startChat(extraHistory?: Content[], resumedSessionData?: ResumedSessionData): Promise<PhillChat>;
    private getIdeContextParts;
    private _getActiveModelForCurrentTurn;
    private processTurn;
    sendMessageStream(request: PartListUnion, signal: AbortSignal, prompt_id: string, turns?: number, isInvalidStreamRetry?: boolean): AsyncGenerator<ServerPhillStreamEvent, Turn>;
