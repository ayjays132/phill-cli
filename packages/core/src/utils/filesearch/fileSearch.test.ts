...
import { createTmpDir, cleanupTmpDir } from 'phill-cli-test-utils';
...
describe('FileSearch', () => {
  ...
  it('should use .phillignore rules', async () => {
  ...
  it('should combine .gitignore and .phillignore rules', async () => {
    tmpDir = await createTmpDir({
      '.git': {},
      '.gitignore': 'dist/',
      [GEMINI_IGNORE_FILE_NAME]: 'build/',
      dist: ['ignored-by-git.js'],
      build: ['ignored-by-phill.js'],
      src: ['not-ignored.js'],
    });
