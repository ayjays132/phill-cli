...
vi.mock('../tools/memoryTool.js', () => ({
  getCurrentPhillMdFilename: vi.fn(() => 'PHILL.md'),
  MemoryTool: vi.fn(),
  PurgeMemoryTool: vi.fn(),
}));
...
describe('FileExclusions', () => {
  ...
  describe('getDefaultExcludePatterns', () => {
    it('should return comprehensive patterns by default', () => {
      ...
      expect(patterns).toContain('**/PHILL.md');
    });
    ...
    it('should respect includeDefaults option', () => {
      ...
      expect(patterns).not.toContain('**/PHILL.md');
    ...
    it('should respect includeDynamicPatterns option', () => {
      ...
      expect(patternsWithDynamic).toContain('**/PHILL.md');
      expect(patternsWithoutDynamic).not.toContain('**/PHILL.md');
    });
  });
