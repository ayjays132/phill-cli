...
phillClient: PhillClient, baseLlmClient: BaseLlmClient, abortSignal: AbortSignal, disableLLMCorrection: boolean): Promise<CorrectedEditResult>;
 ...
 */
export declare function unescapeStringForPhillBug(inputString: string): string;
/**
