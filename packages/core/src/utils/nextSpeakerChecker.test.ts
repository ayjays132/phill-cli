...
import { PhillChat } from '../core/phillChat.js';
...
describe('checkNextSpeaker', () => {
  ...
  beforeEach(() => {
    ...
    // PhillChat will receive the mocked instances via the mocked GoogleGenAI constructor
    chatInstance = new PhillChat(
      mockConfig,
