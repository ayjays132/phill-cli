...
describe('PhillIgnoreParser', () => {
  ...
  beforeEach(async () => {
    projectRoot = await fs.mkdtemp(
      path.join(os.tmpdir(), 'phillignore-test-'),
    );
  });
  ...
  describe('when .phillignore exists', () => {
    beforeEach(async () => {
    ...
    it('should ignore files specified in .phillignore', () => {
    ...
    it('should maintain patterns in memory when .phillignore is deleted', async () => {
      const parser = new IgnoreFileParser(projectRoot, GEMINI_IGNORE_FILE_NAME);
  ...
  describe('when .phillignore does not exist', () => {
  ...
  describe('when .phillignore is empty', () => {
    beforeEach(async () => {
  ...
  describe('when .phillignore only has comments', () => {
    beforeEach(async () => {
      await createTestFile(
        GEMINI_IGNORE_FILE_NAME,
        '# This is a comment\n# Another comment\n',
